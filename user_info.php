...
<head>
  ...
  <script type="text/javascript" src="js/bo_person_register.js"></script>
...
<!-- <div style="padding-top: 8px;">
		<div style="float: left;">							
				<ul class="nav nav-pills">		    		    
				    <li id="user_info" class="active"><a href="user_info.php">User Information</a></li>
				    <li id="cust_info"><a href="cust_info.php">Customer Information</a></li>
				    <li id="saving_info"><a href="saving_info.php">Saving Customer</a></li>
				    <li id="borrow_info"><a href="borrow_info.php">Lending</a></li>
			  	</ul>
		</div>
		<div style="float: right; width: 100px;"> <input type="button" class="btn btn-primary" id="btnlogout" value="ចាក់ចេញ"></div>
</div> -->
...
<div class="container" style="float: left; width: 50%; display:none" id="left">
  ...
  <div class="form-horizontal"  id="forminfo">
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" for="txtPasswd">ពាក្យសម្ងាត់ :</label>
      <div class="col-sm-8">
         <input type="password" class="form-control" name="txtPasswd" maxlength="15" id="txtPasswd" placeholder="ពាក្យសម្ងាត់">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-3" for="txtConfirmpasswd">បញ្ជាក់ពាក្យសម្ងាត់ :</label>
      <div class="col-sm-8">
         <input type="password" class="form-control" name="txtConfirmpasswd" maxlength="15" id="txtConfirmpasswd" placeholder="ពាក្យសម្ងាត់">
      </div>
    </div>
    <div class="form-group"​>
	...
	<div style="overflow: hidden;">
		<h2 align="center">ព៌តមានបុគ្គលិក</h2><br>
