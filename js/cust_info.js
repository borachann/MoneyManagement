...
$(document).ready(function() {
    ...
    showdata();
    $("ul li#cust_info").addClass('active');
    //====================================================== btnprint ==================================================================
    
    //====================================================== check detail ==============================================================
    $(document).on('click', 'tbody tr #btndetail', function() { 
        $.post("php/cust_info.php", {
        DetailUser : {
            custId : $(this).parent().parent().children().html()
        } 
    }, function(data){
        console.log(data);
           if(data.length !=0)        
        {           
            ...
            $("#TBL_DCONTENTS tbody").html("<tr><td colspan='10' style='text-align:center;'><div> No Data</div> </td></tr>");
        }
    });
});
      //==================================================== Log out ===================================================================
    ...
    $(document).on('keyup','#searchname',function(e){
          $.post("http://localhost/money_management/php/cust_info.php", {
            SearchName: {
